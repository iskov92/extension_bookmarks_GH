export default {
  ...
  SETTINGS: {
    ...
    STORAGE_MANAGEMENT: "Extension Storage",
    STORAGE_INFO: "Storage Information",
    STORAGE_CLEAR: "Clear Storage",
    STORAGE_CLEAR_CONFIRM:
      "Are you sure you want to clear storage? All bookmarks, folders, notes and extension settings will be deleted.",
    STORAGE_DATA: "Storage Data",
    STORAGE_BOOKMARKS: "Bookmarks: {count} items",
    STORAGE_SIZE: "Data size: {size}",
    STORAGE_SIZE_USED: "Chrome Storage: {size} ({percent})",
    STORAGE_SIZE_FREE: "Free: {size}",
    STORAGE_INDEXEDDB_SIZE: "IndexedDB: {size} ({percent})",
    STORAGE_ICONS: "Folder images: {count}",
    STORAGE_TRASH: "Trash: {count} items",
    STORAGE_CACHE: "Cache: {size}",
    STORAGE_CLEARED: "Storage successfully cleared",
    FAVICONS: "Display favicons",
    FAVICONS_ENABLED: "Enabled",
    FAVICONS_DISABLED: "Disabled",
    FAVICONS_LOADING: "Installing favicons...",
  },
  TRASH: {
    TITLE: "Trash",

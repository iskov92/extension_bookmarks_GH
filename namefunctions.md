...
- **Заменены иконки выравнивания текста в редакторе заметок** - В `src/components/NoteModal.js` [633-676] — заменены SVG-иконки кнопок выравнивания на логотипы из файлов. Добавлены отдельные версии для светлой и темной тем. В `src/styles/main.css` добавлены соответствующие стили для корректного отображения иконок.
